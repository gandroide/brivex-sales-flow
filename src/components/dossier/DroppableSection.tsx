...
export default function DroppableSection({ section, onRename, onRemoveSection, onUpdateProduct, onRemoveProduct, onDuplicateProduct, onMoveProduct, onEditRequest, availableSections }: SectionProps) {
